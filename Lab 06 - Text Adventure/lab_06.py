...
def main():
    ...
    room = Room("You are in a long stone hallway. There are doorways to the north, east, and west.", 4, 2, None, 0)
    room_list.append(room)

    room = Room("You enter the kitchen. The smell of rotten meat fills the air. There are doorways to the "
                "north and west.", 5, None, None, 1)
    room_list.append(room)

    room = Room("The pantry is messy and smells funny. There are doorways to the west and south.", None, None, 2, 4)
    room_list.append(room)

    room = Room(
        "You step into the bathroom. There is dried blood here. There are doorways to the east and south", None, 4, 0, None)
    room_list.append(room)
    ...
    room = Room("You enter a crowded armory. Racks line the walls filled to the brim with medieval weaponry. There is a"
